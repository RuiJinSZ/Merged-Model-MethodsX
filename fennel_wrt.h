/*
** svn $Id: fennel_wrt.h 795 2016-05-11 01:42:43Z arango $
*************************************************** Hernan G. Arango ***
...
!
     ...
     &                      ncid = ncid)
      ...
      CALL netcdf_put_fvar (ng, model, ncname, 'LDeNSR',                &
     &                      LDeNSR(ng), (/0/), (/0/),                   &
     &                      ncid = ncid)
      IF (exit_flag.ne.NoError) RETURN
     ...
     &                      ncid = ncid)
      ...
      CALL netcdf_put_fvar (ng, model, ncname, 'SDeNSR',                &
     &                      SDeNSR(ng), (/0/), (/0/),                   &
     &                      ncid = ncid)
      IF (exit_flag.ne.NoError) RETURN
     ...
     &                      ncid = ncid)
      ...
      CALL netcdf_put_fvar (ng, model, ncname, 'O2palFrac',             &
     &                      O2palFrac(ng), (/0/), (/0/),                &
     &                      ncid = ncid)
      IF (exit_flag.ne.NoError) RETURN

CALL netcdf_put_fvar (ng, model, ncname, 'ElDON',                 &
     &                      ElDON(ng), (/0/), (/0/),                    &
     &                      ncid = ncid)
      IF (FoundError(exit_flag, NoError, __LINE__,                      &
     &               __FILE__)) RETURN

      CALL netcdf_put_fvar (ng, model, ncname, 'EsDON',                 &
     &                      EsDON(ng), (/0/), (/0/),                    &
     &                      ncid = ncid)
      IF (FoundError(exit_flag, NoError, __LINE__,                      &
     &               __FILE__)) RETURN

      CALL netcdf_put_fvar (ng, model, ncname, 'deltN',                 &
     &                      deltN(ng), (/0/), (/0/),                    &
     &                      ncid = ncid)
      IF (FoundError(exit_flag, NoError, __LINE__,                      &
     &               __FILE__)) RETURN
           CALL netcdf_put_fvar (ng, model, ncname, 'a0N',                   &
     &                      a0N(ng), (/0/), (/0/),                      &
     &                      ncid = ncid)
      IF (FoundError(exit_flag, NoError, __LINE__,                      &
     &               __FILE__)) RETURN
     CALL netcdf_put_fvar (ng, model, ncname, 'rkd1',                  &
     &                      rkd1(ng), (/0/), (/0/),                     &
     &                      ncid = ncid)
      IF (FoundError(exit_flag, NoError, __LINE__,                      &
     &               __FILE__)) RETURN
     CALL netcdf_put_fvar (ng, model, ncname, 'rkdChl1',               &
     &                      rkdChl1(ng), (/0/), (/0/),                  &
     &                      ncid = ncid)
      IF (FoundError(exit_flag, NoError, __LINE__,                      &
     &               __FILE__)) RETURN
     CALL netcdf_put_fvar (ng, model, ncname, 'rkdTSS1',               &
     &                      rkdTSS1(ng), (/0/), (/0/),                  &
     &                      ncid = ncid)
      IF (FoundError(exit_flag, NoError, __LINE__,                      &
     &               __FILE__)) RETURN
      CALL netcdf_put_fvar (ng, model, ncname, 'rkdS1',                 &
     &                      rkdS1(ng), (/0/), (/0/),                    &
     &                      ncid = ncid)
      IF (FoundError(exit_flag, NoError, __LINE__,                      &
     &               __FILE__)) RETURN
